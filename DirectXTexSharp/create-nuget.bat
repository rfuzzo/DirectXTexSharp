...
nuget pack .\DirectXTexSharp.nuspec -Build -NoPackageAnalysis -Properties 'Configuration=Debug;Platform=x64;CConfiguration=Debug;CPlatform=x64;' -OutputDirectory nuget -Version 0.8
