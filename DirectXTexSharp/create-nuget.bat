...
nuget pack .\DirectXTexSharp.nuspec -Build -Symbols -NoPackageAnalysis -Properties 'Configuration=Debug;CConfiguration=Debug;' -OutputDirectory nuget -Version 0.2
